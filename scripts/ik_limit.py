...
if __name__ == "__main__":
    current_qpos = [0.1,0,0,0.1,0,0.1,0.1,0,0,0.1,0,0.1]
    R_x = np.array([
        [1, 0, 0],
        [0, 1, 0],
        [0, 0, 1]
    ...
    while z<= -0.65:
        ...
        ik_qpos_left = inverse_kinematics(6,current_qpos,R_x,[0.001,-0.1,z])
        ik_qpos_right = inverse_kinematics(12,current_qpos,R_x,[0.001,0.1,z])
    ...
    np.save('combined_vectors.npy', np.array(combined_vectors))