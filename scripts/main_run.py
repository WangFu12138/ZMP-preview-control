...
class BipedMotionController:
    ...
    def walk(self):
        ...
        pre = PreviewControl(dt=1. / 240., Tsup_time=1.0, Tdl_time=0.1, previewStepNum=190)
        ...
        np.save('footTrj_left.npy', trjL_log)
        np.save('footTrj_right.npy', trjR_log)
